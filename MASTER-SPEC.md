...
Treat these as logical roles, not names to invent. Discover the current runtime and use only capabilities whose documented behavior safely matches the required operation.
